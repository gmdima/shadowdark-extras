...
export default class PotionSheetSD extends HandlebarsApplicationMixin(DocumentSheetV2) {
     ...
     */
    static TABS = {
        details: { id: "details", group: "primary", label: "SHADOWDARK_EXTRAS.potionSheet.tabs.details", icon: "fas fa-list" },
        activity: { id: "activity", group: "primary", label: "SHADOWDARK_EXTRAS.potionSheet.tabs.activity", icon: "fas fa-bolt" },
        description: { id: "description", group: "primary", label: "SHADOWDARK_EXTRAS.potionSheet.tabs.description", icon: "fas fa-book" },
        macro: { id: "macro", group: "primary", label: "SHADOWDARK_EXTRAS.potionSheet.tabs.macro", icon: "fas fa-code" }
    };
