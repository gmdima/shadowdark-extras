...
export async function playWeaponAnimation(token, item) {
    ...
    switch (animType) {
        case "wobble":
            effect
                .animateProperty("sprite", "angle", {
                    from: (animConfig.rotation ?? 0),
                    to: (animConfig.rotation ?? 0) + 10,
                    duration: 200,
                    ease: "easeOutBack"
                })
                .loopProperty("sprite", "angle", {
                    from: (animConfig.rotation ?? 0) + 2,
                    to: (animConfig.rotation ?? 0) - 2,
                    duration: 1500,
                    ease: "easeInOutSine",
                    pingPong: true
                });
